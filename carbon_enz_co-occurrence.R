...
head(rez)
names(rez)<-c("g1","g2","lm_mean","micro_mean","mm_mean","sm_mean","mean","lm_sd","micro_sd","mm_sd","sm_sd","sd","lm_hi","micro_hi","mm_hi","sm_hi","hi","lm_lo","micro_lo","mm_lo","sm_lo","lo")
